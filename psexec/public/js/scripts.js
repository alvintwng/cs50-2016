...
var imgcontent = '/buildphoto/38eightriversuites.JPG';  // dont work!
//var imgcontent = '/buildphoto/71springside_alvin.JPG';
...
$(function() {
    ...
    var options = {
        ...
        center: {lat: 1.35, lng: 103.83}, // Singapore
...
{
    // TODO //
    //listAllProperties(place); // for DEBUG
    ...
    var marker = new MarkerWithLabel({
     ...
     labelClass: "label", // the CSS class for the label, styles.css:96
     labelStyle: {opacity: 1.00}
     });
    markers.push(marker); //  push to the array.
    
    google.maps.event.addListener(marker, 'click',function(){
     // get list info windows
     arefinfo(marker, place.place_name);
...
/**
 * create content of lising, and out to window.
 * by NgTW
 */
function arefinfo(marker, query)
{
    var content = ''; // start of ordered list
          content += ('<a href ="postpage.php?geo='+query+'" >'+query+'</a>' );
          content += "";
...
function update() 
{
    ...
    //console.log('#Debug_UPDATE1'); //DEBUG
    //console.log(parameters); //DEBUG
    $.getJSON("update.php", parameters)
    .done(function(data, textStatus, jqXHR) {

        //console.log('#Debug_UPDATE2A'); //DEBUG
     ...
     .fail(function(jqXHR, textStatus, errorThrown) {
         ...
         console.log('#Debug_UPDATE2B'); //DEBUG
         console.log(parameters); //DEBUG
         // log error to browser's console
         console.log(errorThrown.toString());
     });
     //console.log('#Debug_UPDATE3'); //DEBUG
}
